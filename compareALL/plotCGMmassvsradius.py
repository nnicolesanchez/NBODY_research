...
for i in range(len(names)):
    ...
    plt.plot(radii[:-1],np.log10(warm),color=colors2[0],linestyle=lines[0],label=r'T = 10$^{5}$ - 10$^{6}$')
    plt.plot(radii[:-1],np.log10(warm1),color=colors2[1],linestyle=lines[1],label=r'T = 10$^{5}$ - 10$^{5.7}$')
    plt.plot(radii[:-1],np.log10(warm2),color=colors2[2],linestyle=lines[2],label=r'T = 10$^{5.7}$ - 10$^{6}$')
