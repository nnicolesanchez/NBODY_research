...
print('# of Gas particles w/ Z < -0.9 K',len(new_GM4_gasmetal[new_GM4_gasmetal < -0.9]))
print('# of Gas particles w/ Z > 1.1 K',len(new_GM4_gasmetal[new_GM4_gasmetal > 1.1]))

plt.scatter(new_GM4_gaspos[:,0],new_GM4_gaspos[:,1],c=np.log10(new_GM4_gasmetal),s=10,cmap=plt.cm.get_cmap('jet'),alpha=0.5,vmin=-5,vmax=15)
plt.title('GM4 Gas Particles (Matched with GM1 Gas)')
plt.xlabel('X [kpc]')
plt.ylabel('Y [kpc]')
plt.ylim(-2500,1500)
...
print('# of Gas particles w/ Z < -5',len(new_GM1_gasmetal[new_GM1_gasmetal < -5]))
print('# of Gas particles w/ Z > 15 K',len(new_GM1_gasmetal[new_GM1_gasmetal > 15]))

plt.scatter(new_GM1_gaspos[:,0],new_GM1_gaspos[:,1],c=np.log10(new_GM1_gasmetal),s=10,cmap=plt.cm.get_cmap('jet'),alpha=0.5,vmin=-5,vmax=15)
plt.title('GM1 Gas Particles (Matched with GM4 Gas)')
plt.xlabel('X [kpc]')
plt.ylabel('Y [kpc]')
plt.ylim(-2500,1500)
